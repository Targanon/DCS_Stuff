...
function FARPCREATOR:CreateMenu(targetgroup,_client)
  ...
  function FARPCREATOR:spawn(_client)
    ...
    temptable.FarpServiceConvoy:RouteAirTo(temptable.FARPCoordinate, 0, 0, "LandingZone", 130) -- edited : set speed to 60klm : FARPCoordinate,45,1,"Landing"
                                --RouteAirTo( ToCoordinate, AltType, Type, Action, Speed, DelaySeconds )
