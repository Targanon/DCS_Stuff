...
do
    ...
    local PointVec3 = POINT_VEC3:New( -100, 10, -100  ) -- This is a Vec3 class - defines the position of the escorts relative to the escorted group
    local PointVec4 = POINT_VEC3:New( -100, 10, 100  ) -- This is a Vec3 class - defines the position of the escorts relative to the escorted group
    
    --Create Spawn Groups, use the OnSpawnGroup() function to spawn two escorts and task them
       
    local AWACS_Overlord = SPAWN
      :New("Darkstar_E-7A Wedgetail-241-1")
