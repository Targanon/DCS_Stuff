...
ctld.numberOfTroops = 14 -- default number of troops to load on a transport heli or C-130 
...
ctld.maxDistanceFromCrate = 10.5 -- Maximum distance from from crate for hover
...
-- ["UH-60L"] = {crates=true, troops=false},
--
...
ctld.loadableGroups = {
    {name = "Mixed Group", inf = 5, mg = 2, at = 2, aa = 1 }, -- will make a loadable group with 5 infantry, 2 MGs and 2 anti-tank for both coalitions
...
ctld.spawnableCrates = {
    ...
    ["Ground Forces"] = {
        ...
        { weight = 1600, desc = "FOB Crate - Large", unit = "FOB" }, -- Builds a FOB! - requires 1 * ctld.cratesRequiredForFOB
    },
    ["AA Crates"] = {
...
--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS--TARGS

function ctld.spawnFOB(_country, _unitId, _point, _name) -- this is more then likely where I put code for Farp 
    ...
    local _farp = {
     ...
     --   ["unitId"] = _id,
        ...
        --["heading"] = (FarpHDG - 0.00000000),
        ["canCargo"] = false,
        ["heading"] = 0,
    }
    --coalition.addStaticObject(_country, _farp)
